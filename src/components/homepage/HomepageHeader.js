    ...
    <header className="bg-white">
      <div className="flex flex-col justify-center items-center space-y-8 container mx-auto text-center py-24">
        ...
        <div className="flex flex-row justify-center space-x-10">
          <Link to="/docs/intro" className="bg-purple-500 text-white rounded-lg px-6 md:px-16 py-3 shadow-xl shadow-purple-200 hover:text-purple-500 hover:bg-white hover:border-purple-500 transition duration-700 ease-in-out">
            Start Learning
          </Link>
        </div>
