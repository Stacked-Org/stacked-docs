    ...
    <>
      <main className="px-6 py-1 min-h-[80vh] flex flex-col items-center justify-center">
        ...
        >
          ...
          <Link to="https://pub.dev/packages/stacked" target="_blank" className="mt-6 hover:text-white hover:no-underline px-6 py-4 text-lg font-semibold text-white transition-all bg-sky-700 border-none rounded outline-none cursor-pointer ring-transparent focus:ring-purple-500 ring hover:bg-[#444] active:scale-90">
            <Translate id="index.main.likeUs">Like us on Pub 👍</Translate>
          </Link>
        </motion.div>
      </main>
